    ...
    return (
        <div className='md:w-96 flex flex-col items-center'>
            ...
            <div className='number-selector my-4 grid grid-cols-5'>
                ...
                <div className={`m-1 kbd cursor-pointer ${numberSelected === 0 ? 'ring-1 ring-neutral' : ''}`} onClick={() => handleNumberSelect(0)}>
            ...
            {isSuccess && 
                <div className='my-2 badge badge-primary badge-lg'>You've won !</div>
